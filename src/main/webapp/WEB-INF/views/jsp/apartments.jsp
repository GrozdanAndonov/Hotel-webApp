...
<body class="components-page profile-page ">
    ...
    <div class="container">
				                   ...
				                   <!-- ------------------- -->  
										...
										<div class="tab-pane active" id="studio">
				                           ...
				                           <div>
												...
												<figure class="find-them-all">
												 <a href="<c:url value="/img/apartments/P7171067.jpg"/>"  data-size="600x400" data-index="1">
													<img src="<c:url value="/img/apartments/P7171067.jpg"/>"  class="img-rounded"  />
													</a>
											</figure>
										<figure class="find-them-all">
												<a href="<c:url value="/img/apartments/P6031695.jpg"/>"  data-size="600x400" data-index="2">
													<img src="<c:url value="/img/apartments/P6031695.jpg"/>" class="img-rounded" />
													</a>
												</figure>
													<figure class="find-them-all">													 
													 <a href="<c:url value="/img/apartments/P1012094.jpg"/>"  data-size="600x400" data-index="8">
												...
												<div class="col-md-6">
												<figure class="find-them-all">
												 <a href="<c:url value="/img/apartments/P7290403.jpg"/>"  data-size="600x400" data-index="3">
													<img src="<c:url value="/img/apartments/P7290403.jpg"/>" class="img-rounded" />
													</a>
													</figure>
													<figure class="find-them-all">
												 <a href="<c:url value="/img/apartments/P7290405.jpg"/>"  data-size="600x400" data-index="4">
													<img src="<c:url value="/img/apartments/P7290405.jpg"/>" class="img-rounded" />
													</a>
													</figure>
													<figure class="find-them-all">													 
													 <a href="<c:url value="/img/apartments/PA091819.jpg"/>"  data-size="600x400" data-index="8">
				                        ...
				                        <div class="tab-pane text-center" id="work">
											<div class="row">
												<div class="col-md-6">
												<figure class="find-them-all">
												 <a href="<c:url value="/img/apartments/P7290409.jpg"/>"  data-size="600x400" data-index="5">
													<img src="<c:url value="/img/apartments/P7290409.jpg"/>" class="img-rounded" />
													</a>
													</figure >
													<figure class="find-them-all">
												 <a href="<c:url value="/img/apartments/Grozdan & N-29.jpg"/>"  data-size="600x400" data-index="6">
													<img src="<c:url value="/img/apartments/Grozdan & N-29.jpg"/>" class="img-rounded" />
													</a></figure>
													<figure class="find-them-all">
												 <a href="<c:url value="/img/apartments/P1011507.jpg"/>"  data-size="600x400" data-index="7">
												...
												<div class="col-md-6">
													 ...
													 <figure class="find-them-all">													 
													 <a href="<c:url value="/img/apartments/Grozdan & N-36.jpg"/>"  data-size="600x400" data-index="8">
													<img src="<c:url value="/img/apartments/Grozdan & N-36.jpg"/>" class="img-rounded" />
													</a>
													</figure>
													<figure class="find-them-all">
												 	<a href="<c:url value="/img/apartments/PA091820.jpg"/>"  data-size="600x400" data-index="9">
										...
										<div class="tab-pane text-center" id="shows">
											<div class="row">
												<div class="col-md-6">
												<figure class="find-them-all">
												 <a href="<c:url value="/img/apartments/P1012100.jpg"/>"  data-size="600x400" data-index="10">
													<img src="<c:url value="/img/apartments/P1012100.jpg"/>" class="img-rounded" />
													</a>
													</figure >
													<figure class="find-them-all">
														 <a href="<c:url value="/img/apartments/P1012102.jpg"/>"  data-size="600x400" data-index="11">
												...
												<div class="col-md-6">
												<figure class="find-them-all">
												 <a href="<c:url value="/img/apartments/Grozdan & N-49.jpg"/>"  data-size="600x400" data-index="12">
													<img src="<c:url value="/img/apartments/Grozdan & N-49.jpg"/>" class="img-rounded" />
													</a>
													</figure>
													<figure class="find-them-all"> 
													 <a href="<c:url value="/img/apartments/Grozdan & N-47.jpg"/>"  data-size="600x400" data-index="13">
													<img src="<c:url value="/img/apartments/Grozdan & N-47.jpg"/>" class="img-rounded" />
													</a>
													</figure>
													<figure class="find-them-all">													
													 <a href="<c:url value="/img/apartments/P1011507.jpg"/>"  data-size="600x400" data-index="14">
													<img src="<c:url value="/img/apartments/P1011507.jpg"/>" class="img-rounded" />
													</a>
													</figure>
												</div>
        ...
        <tr>
            ...
            <td><strong><s:message code="constr.apartments"></s:message>Тип конструкция -</strong> <s:message code="typeConstr.apartments"></s:message></td>
        </tr>
        <tr>
