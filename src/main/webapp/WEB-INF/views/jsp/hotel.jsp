...
<body class="components-page profile-page">
   ...
   <div class="wrapper">
    ...
    <tbody >
        <tr>
            ...
            <td><strong><i class="material-icons">&#xE63E;</i><s:message code="descrFeatures1.hotel"></s:message></strong></td>
             <td><strong><i class="material-icons">&#xE531;</i><s:message code="descrFeatures2.hotel"></s:message><a href="/Grozdan-hotel-SAIT/rentACar">RENT A CAR</a></strong></td>
    ...
    <thead>
        <tr>
            <th class="text-center"><i class="material-icons">&#xE7EF;</i></th>
            <th><s:message code="typeRooms1.hotel"></s:message> </th>
            <th><s:message code="typeRooms2.hotel"></s:message></th>
            <th class="text-right"><s:message code="typeRooms3.hotel"></s:message></th>
    ...
    <tbody>
        <tr>
            ...
            <td><a href="/Grozdan-hotel-SAIT/hotel/doubleRoom"><strong><s:message code="typeRooms4.hotel"></s:message></strong></a></td>
            <td><strong>5</strong></td>
            <td class="text-right"><strong>35<s:message code="typeRooms7.hotel"></s:message></strong></td>           
        </tr>
        <tr>
            <td class="text-center"><strong>2</strong></td>
            <td><a href="/Grozdan-hotel-SAIT/hotel/tripleRoom"><strong><s:message code="typeRooms5.hotel"></s:message></strong></a></td>
            <td><strong>3</strong></td>
            <td class="text-right"><strong>45<s:message code="typeRooms7.hotel"></s:message></strong></td>
        </tr>
         <tr>
            <td class="text-center"><strong>3</strong></td>
            <td><a href="/Grozdan-hotel-SAIT/hotel/apartment"><strong><s:message code="typeRooms6.hotel"></s:message></strong></a></td>
            <td><strong>2</strong></td>
            <td class="text-right"><strong>50/75<s:message code="typeRooms7.hotel"></s:message></strong></td>
        </tr>
    </tbody>
</table>
</div>
				                   ...
				                   <!-- ------------------- -->  
				                           ...
				                           <div>
												<div class="col-md-6">		
													<figure class="find-them-all">
													 <a href="<c:url value="/img/hotel/PB151855.jpg"/>"  data-size="600x400" data-index="14">
													<img src="<c:url value="/img/hotel/PB151855.jpg"/>" class="img-rounded" />
													</a>
													</figure>								
												<figure class="find-them-all">
												 <a href="<c:url value="/img/hotel/Grozdan & N-61.jpg"/>"  data-size="600x400" data-index="1">
													<img src="<c:url value="/img/hotel/Grozdan & N-61.jpg"/>"  class="img-rounded"  />
													</a>
											</figure>
										<figure class="find-them-all">
												<a href="<c:url value="/img/hotel/Grozdan & N-63.jpg"/>"  data-size="600x400" data-index="2">
												...
												<div class="col-md-6">
												<figure class="find-them-all">
												 <a href="<c:url value="/img/hotel/Grozdan & N-69.jpg"/>"  data-size="600x400" data-index="3">
													<img src="<c:url value="/img/hotel/Grozdan & N-69.jpg"/>" class="img-rounded" />
													</a>
													</figure>
													<figure class="find-them-all">
													 <a href="<c:url value="/img/hotel/Grozdan & N-70.jpg"/>"  data-size="600x400" data-index="4">
				                        ...
				                        <div class="tab-pane text-center" id="work">
											<div class="row">
												<div class="col-md-6">
												<figure class="find-them-all">
												 <a href="<c:url value="/img/hotel/P1012003.jpg"/>"  data-size="600x400" data-index="5">
													<img src="<c:url value="/img/hotel/P1012003.jpg"/>" class="img-rounded" />
													</a>
													</figure >													
													<figure class="find-them-all">
												 <a href="<c:url value="/img/hotel/P1012046.jpg"/>"  data-size="600x400" data-index="7">
												...
												<div class="col-md-6">
													 ...
													 <figure class="find-them-all">
													 <a href="<c:url value="/img/hotel/P1012042.jpg"/>"  data-size="600x400" data-index="8">
													<img src="<c:url value="/img/hotel/P1012042.jpg"/>" class="img-rounded" />
													</a>
													</figure>
													<figure class="find-them-all">
												 	<a href="<c:url value="/img/hotel/P1012041.jpg"/>"  data-size="600x400" data-index="9">
													<img src="<c:url value="/img/hotel/P1012041.jpg"/>" class="img-rounded" />
													</a>
													</figure>
													<figure class="find-them-all">
												 <a href="<c:url value="/img/hotel/P1012037.jpg"/>"  data-size="600x400" data-index="6">
										...
										<div class="tab-pane text-center" id="shows">
											<div class="row">
												<div class="col-md-6">
												<figure class="find-them-all">
												 <a href="<c:url value="/img/hotel/PB151852.jpg"/>"  data-size="600x400" data-index="10">
													<img src="<c:url value="/img/hotel/PB151852.jpg"/>" class="img-rounded" />
													</a>
													</figure >
													<figure class="find-them-all">
														 <a href="<c:url value="/img/hotel/P1012005.jpg"/>"  data-size="600x400" data-index="11">
												...
												<div class="col-md-6">
												<figure class="find-them-all">
												 <a href="<c:url value="/img/hotel/P1012025.jpg"/>"  data-size="600x400" data-index="12">
													<img src="<c:url value="/img/hotel/P1012025.jpg"/>" class="img-rounded" />
													</a>
													</figure>
													<figure class="find-them-all"> 
													 <a href="<c:url value="/img/hotel/P1012028.jpg"/>"  data-size="600x400" data-index="13">
													<img src="<c:url value="/img/hotel/P1012028.jpg"/>" class="img-rounded" />
													</a>
													</figure>	
													<figure class="find-them-all"> 
													 <a href="<c:url value="/img/hotel/800px-Sandanski-1296574665.jpg"/>"  data-size="600x400" data-index="13">
